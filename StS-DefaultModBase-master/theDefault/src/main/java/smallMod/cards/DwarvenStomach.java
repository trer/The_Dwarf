...
public class DwarvenStomach extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(DwarvenStomach.class.getSimpleName());
