...
import smallMod.cards.*;
import smallMod.characters.TheDefault;
import smallMod.events.IdentityCrisisEvent;
import smallMod.potions.PlaceholderPotion;
import smallMod.relics.BottledPlaceholderRelic;
import smallMod.relics.DefaultClickableRelic;
import smallMod.relics.BloodOfGold;
import smallMod.relics.GoldSickness;
import smallMod.relics.PlaceholderRelic2;
import smallMod.util.IDCheckDontTouchPls;
import smallMod.util.TextureLoader;
import smallMod.variables.DefaultCustomVariable;
import smallMod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String MODNAME = "Small Mod";
    private static final String AUTHOR = "Trer"; // And pretty soon - You!
    private static final String DESCRIPTION = "A tiny mod.";
    ...
    private static final String ATTACK_DEFAULT_GRAY = "smallModResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "smallModResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "smallModResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "smallModResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "smallModResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "smallModResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "smallModResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "smallModResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "smallModResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DWARF_BUTTON = "smallModResources/images/charSelect/the-dwarf-button.png";
    private static final String THE_DWARF_PORTRAIT = "smallModResources/images/charSelect/the-dwarf-artwork-j4.jpg";
    public static final String THE_DEFAULT_SHOULDER_1 = "smallModResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "smallModResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "smallModResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "smallModResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "smallModResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "smallModResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditCharacters() {
        ...
        BaseMod.addCharacter(new TheDefault("the Dwarf", TheDefault.Enums.THE_DEFAULT),
                THE_DWARF_BUTTON, THE_DWARF_PORTRAIT, TheDefault.Enums.THE_DEFAULT);
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new BloodOfGold(), TheDefault.Enums.COLOR_GRAY);
        BaseMod.addRelicToCustomPool(new BottledPlaceholderRelic(), TheDefault.Enums.COLOR_GRAY);
        BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), TheDefault.Enums.COLOR_GRAY);
        BaseMod.addRelicToCustomPool(new GoldSickness(), TheDefault.Enums.COLOR_GRAY);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("SmallMod") // ${project.artifactId}
