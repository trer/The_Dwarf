...
import smallMod.cards.Skullcracker;
import smallMod.util.TextureLoader;

public class GainEnergyPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("GainEnergyPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    // We create 2 new textures *Using This Specific Texture Loader* - an 84x84 image and a 32x32 one.
    private static final Texture tex84 = TextureLoader.getTexture("smallModResources/images/powers/placeholder_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture("smallModResources/images/powers/placeholder_power32.png");

    public GainEnergyPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new GainEnergyPower(owner, source, amount);
    }
}

/*
AbstractCard playCard = new Skullcracker(); // Declare Card - the DefaultRareAttack card. We will name it 'playCard'.
